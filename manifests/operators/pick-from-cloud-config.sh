...
# The base manifests/simple-go-web-app.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/simple-go-web-app.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
